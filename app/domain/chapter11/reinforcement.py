...
class ReinforcementLimitsService:
    ...
    # Nota: Las funciones de zonas de extremo §18.10.2.4 (calculate_end_zone_rho_min,
    # get_end_zone_length) fueron movidas a chapter18/reinforcement/service.py
    # ya que pertenecen al Capítulo 18, no al Capítulo 11.
